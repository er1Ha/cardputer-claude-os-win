...
Usage:
    python push.py --port /dev/cu.usbserial-XXXX    # macOS/Linux
    python push.py --port COM5                       # Windows
    # (On Windows, find the COM number in Device Manager under
    # "Ports (COM & LPT)" after the device enters download mode.)
