...
Usage:
    python3 buddy/scripts/push_pager_mpy.py --port /dev/cu.usbmodem2101  # macOS
    python buddy/scripts/push_pager_mpy.py --port COM5                    # Windows

Requires `mpy-cross` (Python wrapper around the MicroPython cross
compiler). Install with:
    pip install --user mpy-cross               # Windows / generic
    pip3 install --user --break-system-packages mpy-cross   # macOS Sonoma+
